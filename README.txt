...
Jeden zaszyfrowany kluczem alicj-trent (session_key, Bob_id, alice_nonce)
Drugo zaszyfrowany kluczem trent-bob (session_key, Alice_id, bob_nonce)
Alicja 1 wiadomość deszyfruja za pomoca klucza alicja-ternt.
2 wiadomosc wysyla do boba.
Po deszyfracji Bob i Alicja posiadaja KLUCZ SESYJNY
Nastepnie uruchamiany jest proces autentykacji na serwerze Bob.
